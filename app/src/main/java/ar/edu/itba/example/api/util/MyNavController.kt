...
import ar.edu.itba.example.api.ui.main.MyNavigationRail
...
fun MyNavHost(
    ...
    Scaffold(
        topBar = { if (showTopBar && vertical) {MyTopBar(
            title = title,
        ...
        bottomBar = { if (showBottomBar && vertical) {MyBottomBar(
        ...
        Row{
            if (showBottomBar && !vertical){
                MyNavigationRail(currentRoute = currentRoute, onNavigate = {route -> navController.navigate(route)})
            }
            NavHost(
            ...
            composable("home"){route ->
                ...
                composable(
                    ...
                    title = stringResource(id = R.string.execution)
                    showTopBar = false
                    showBottomBar = false
                    showBackButton = true
                    showSettingsButton = false
